...
## Workflow de Revisão de Provas ⚠️ TODO! 

O sistema implementa um workflow estruturado para revisão de provas: ❌ TODO: VISTA SÓ PARA ISTO ❌
...
- **Upload de enunciados** de testes e projetos pelos professores ✅ (falta projs)
- **Biblioteca de materiais** de estudo organizados por UC ❌ TODO: VISTA SÓ PARA ISTO ❌
...
- Criar, visualizar e gerir testes e projetos associados a uma UC; ✅(falta projs)
...
- Atribuir notas a alunos em testes e projetos (pelos Professores Regentes e Assistentes); ✅(falta projs)
...
- **Submissões múltiplas de projetos** com histórico de versões, sendo a última submissão considerada como válida. ⬅️ FAZÍVEL
- **Avaliação automática de projetos** com feedback detalhado (ex: testes unitários acionados pelo backend).
- **Dashboard personalizado** com vistas específicas: ⬅️ FAZÍVEL
...
- **Sistema de estatísticas avançado** da UC: distribuição de notas, médias por teste/projeto, número de revisões submetidas/aprovadas... ⬅️ +-
- **Notificações na aplicação e/ou Email** para eventos importantes (ex: submissão de projeto, atribuição de nota, pedido de revisão...). Para envio de emails, é recomendado usar [MailCrab](https://github.com/tweedegolf/mailcrab). ⬅️ +-
