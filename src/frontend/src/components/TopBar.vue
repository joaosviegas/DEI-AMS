...
const navbarItems = computed(() => [
  ...
  { name: 'Workflow de Notas', path: '/workflow', icon: 'mdi-clipboard-list', roles: ['STUDENT', 'TEACHING_ASSISTANT', 'MAIN_TEACHER'] },
  ...
  { name: 'Calendário', path: '/calendar', icon: 'mdi-calendar-month', roles: ['STUDENT', 'TEACHING_ASSISTANT', 'MAIN_TEACHER', 'ADMINISTRATOR'] },
